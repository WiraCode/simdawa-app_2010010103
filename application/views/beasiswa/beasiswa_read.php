            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="<?= base_url('beasiswa/cetak') ?>" terget="_blank" class="btn btn-sm btn-info mr-1 float-right">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                foreach ($beasiswa as $a) {
                                    ...
                                    <td>" . $a->keterangan . "</td>
                                    <td>
                                    <a href=" . base_url('jenis/ubah/' . $a->id) . " class='btn btn-sm btn-info'><i class='fas fa-edit'>
                                    </i> Ubah
                                    </a>
                                    <a href=" . base_url('beasiswa/hapus/1' . $a->id) . " onclick='return confirm(\"ingin hapus data ini?\")' class='btn btn-sm btn-danger'><i class='fas fa-trash'>
                                    </i> Hapus
                                    </a>
                                    </td>
                                    </tr>";
